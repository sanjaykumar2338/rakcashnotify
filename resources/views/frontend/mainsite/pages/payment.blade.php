...
<div class="container-fluid price" id="plans">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
            ...
            <p>Stay ahead of the game with our {{$plan->name}} Notification Plan. Subscribe to receive instant alerts and notifications about exclusive deals, discounts, and offers tailored just for you. With this plan, you'll never miss out on any opportunity to save more and stay informed.</p>
        </div>
    </div>
</div>
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-12 wow fadeInLeft" data-wow-delay="0.1s">
                ...
                <img style="display:none;" src="/loader.gif" class="processing" alt="Processing..."/></div></div>
